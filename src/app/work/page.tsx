...
const projects = [
  {
    ...
    title: "project 1",
    description:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut, rem! Fuga nostrum accusamus dicta, placeat, quaerat debitis labore ea error ut dolore ad facilis maiores. Molestiae voluptas iusto ad et?",
    stack: [
      { name: "HTML 5" },
      { name: "Css 3" },
      { name: "Javascript" },
