...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex h-[48px] w-full items-center justify-between rounded border border-blue-950 bg-background px-4 py-5 text-base text-white/80 placeholder:text-white/10 focus:border-accent outline-none",
        className
      )}
      {...props}
    >
